...
public class CursorView extends HorizontalScrollView {
    ...
    private boolean pickTabTextBold;
    private float pickTabTextSize;
    private ColorStateList normTabTextColors;
    private float normTabTextSize;
...
//        textView.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            final View tabView = (tabProvider == null) ? createDefaultTabView(adapter.getPageTitle(i), i) : tabProvider.createTabView(tabStrip, i, adapter);
     ...
     * {@link #setCustomTabView(com.sunzn.cursor.library.CursorView.TabProvider)}
     */
